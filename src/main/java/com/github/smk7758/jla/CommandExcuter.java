	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		if (cmd.getName().equalsIgnoreCase("setspawn")) {
			...
			if (args.length == 0) {
				...
				Player p = (Player) sender;
				plugin.Teleport(p, plugin.LoadConfig.SpawnLoc());
...
//						plugin.cLog.Message(sender, "You don't have Permission to use test.", 2);
//						return false;
//					}
//					if (args.length > 1) {
...
//						}
//					}
//					plugin.cLog.Message(sender, "JoinMsg, LeaveMsg, Inv", 2);
//					plugin.sendCommandList(sender);
//					return false;
//				}
